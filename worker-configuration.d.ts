/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f248c52af3ac4eaab13e983751d9d172)
...
interface __BaseEnv_Env {
	...
	DYNASTIES: DurableObjectNamespace<import("./worker/index").Dynasty>;
	LEDGER: DurableObjectNamespace<import("./worker/index").Ledger>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "Dynasty" | "Ledger";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DAILY_AI_BUDGET" | "GAME_AI_BUDGET" | "OPENROUTER_API_KEY">> {}
}
